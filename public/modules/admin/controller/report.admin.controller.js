...
angular.module('adminModule').controller('reportAdminController', ['$scope', 'connectAdminFactory', 'socketConfigFactory', function($scope, connectAdminFactory, socketConfigFactory) {
